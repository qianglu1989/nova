 ...
 * 用于请求信息封装
 */
public class RedefineVersionRequest {
    ...
    private RedefineVersionRequest(
    ...
    public static class Builder{
        ...
        public RedefineVersionRequest build() {
            return new RedefineVersionRequest(uri, serviceId, ip, params, headers, requestBody);
        }
    }
