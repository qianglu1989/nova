...
public interface RequestVersionExtractor {
     ...
     * @return
     */
    String extractVersion(RedefineVersionRequest versionRequest);
    ...
    class Default implements RequestVersionExtractor {
        ...
        @Override
        public String extractVersion(RedefineVersionRequest versionRequest) {
            return versionRequest.getParams().getFirst(VERSION);
        }
    }
}
